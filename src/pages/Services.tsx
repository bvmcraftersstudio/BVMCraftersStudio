...
const Services = () => {
  ...
  const portfolioPackages = [
    {
      category: "HTML/CSS/JS Websites",
      packages: [
        { pages: "1 Page", price: "₹149", description: "Perfect for simple portfolios" },
        { pages: "2 Pages", price: "₹199", description: "About + Portfolio showcase" },
        { pages: "3 Pages", price: "₹249", description: "Complete professional presence" },
        { pages: "4 Pages", price: "₹300", description: "Comprehensive portfolio site" }
      ]
    },
    {
      category: "React/Tailwind CSS (Recommended)",
      packages: [
        { pages: "1 Page", price: "₹199", description: "Modern single-page portfolio" },
        { pages: "2 Pages", price: "₹249", description: "Advanced portfolio with blog" },
        { pages: "3 Pages", price: "₹300", description: "Complete business portfolio" },
        { pages: "4 Pages", price: "₹400", description: "Enterprise-level portfolio" }
      ],
      recommended: true
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 lg:py-24 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-12">
            {portfolioPackages.map((category, categoryIndex) => (
              <div key={categoryIndex}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {category.packages.map((pkg, pkgIndex) => (
                    <Card key={pkgIndex} className="text-center p-6 hover:shadow-elegant transition-all duration-300 hover:-translate-y-1">
                      <CardHeader>
      ...
      <section className="py-16 lg:py-24 bg-gradient-hero">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4">Why Choose ResumeForge?</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">500+ students have successfully landed jobs and internships with our help.</p>
            </div>
          </div>
        </div>
      </section>
