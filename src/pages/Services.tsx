...
//       packages: [
//         { pages: "1 Page", price: "₹249", description: "Perfect for simple portfolios" },
//         { pages: "2 Pages", price: "₹359", description: "About + Portfolio showcase" },
//         { pages: "3 Pages", price: "₹450", description: "Complete professional presence" },
//         { pages: "4 Pages", price: "₹550", description: "Comprehensive portfolio site" }
//       ]
//     },
//     {
//       category: "React/Tailwind CSS (Recommended)",
//       packages: [
//         { pages: "1 Page", price: "₹360", description: "Modern single-page portfolio" },
//         { pages: "2 Pages", price: "₹450", description: "Advanced portfolio with navigation" },
//         { pages: "3 Pages", price: "₹590", description: "Complete student portfolio" },
//         { pages: "4 Pages", price: "₹759", description: "Student portfolio with smooth attractive design" }
//       ],
//       recommended: true
//     }
//   ];
